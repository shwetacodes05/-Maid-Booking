...
<body>
    ...
    <div class="services-box">
        <div class="services">
            ...
            <div class="btn">
                <a href="Packages4.jsp"><button class="select">Baby Care</button></a>
            </div>
        </div>
        <div class="services">
            ...
            <div class="btn">
                <a href="Packages5.jsp"><button class="select">Clothes Wash</button></a>
            </div>
        </div>
        <div class="services">
            ...
            <div class="btn">
                <a href="Packages6.jsp"><button class="select">Gardening</button></a>
            </div>
        </div>
    </div>
</body>
