...
<body>
    ...
    <div class="content">
        <form action="Admin_Hiremaid.jsp" method="post">
            ...
            <label for="maid_id">Maid ID:</label>
            <input type="number" name="maid_id" id="maid_id" placeholder="Enter the Maid_ID" required>
            ...
            <label for="hire_date">Booking Date:</label>
            ...
            <%
                ...
                if (maid_id != null && !maid_id.isEmpty() && client_name != null && !client_name.isEmpty() && client_address != null && !client_address.isEmpty() && 
                    service_type != null && !service_type.isEmpty() && hire_date != null && !hire_date.isEmpty()) {
                    
                    try {
                        Statement st1 = con.createStatement();
                        String str1 = "INSERT INTO hire_maid (booking_id, maid_id, m_name, client_name, client_address, service_type, hire_date) VALUES ('" + booking_id + "', '" + maid_id + "', '" + m_name + "', '" + client_name + "', '" + client_address + "', '" + service_type + "', '" + hire_date + "')";
                        int a = st1.executeUpdate(str1);
                        if (a > 0) {
                            out.println("<script>alert('Maid Hired Successfully'); window.location.href='Main_Homepage.jsp';</script>");
                        }
                    } catch (SQLException e) {
