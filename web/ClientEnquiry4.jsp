...
<body>
    ...
    <div class="form-container">
        ...
        <form method="POST">
            <h3>Selected service is Baby Care</h3>
            <%
                int i = 0;
            ...
            <input type="text" name="specialinstruction" id="specialinstruction" placeholder="Special Instruction" required>
            ...
            <%
                if ("POST".equalsIgnoreCase(request.getMethod())) {
                    ...
                    if (clientid != null && name != null && email != null && address != null && 
                        ...
                        hiringdate != null && specialinstruction != null) {

                        try {
                            String query = "INSERT INTO client_enquiry4 (clientid, name, email, address, mobilenumber, workingtime, duration, hiringdate, specialinstruction) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                            ...
                            pst.setInt(9, Integer.parseInt(specialinstruction));
