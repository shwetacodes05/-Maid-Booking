...
<body>
    ...
    <div class="form-container">
        ...
        <form method="POST">
            <h3>Selected service is Clothes Wash</h3>
            <%
                int i = 0;
            ...
            <input type="text" name="additionalservices" id="additionalservices" placeholder="Additional Services " required>
            ...
            <%
                if ("POST".equalsIgnoreCase(request.getMethod())) {
                    ...
                    if (clientid != null && name != null && email != null && address != null && 
                        ...
                        hiringdate != null && additionalservices != null) {

                        try {
                            String query = "INSERT INTO client_enquiry5 (clientid, name, email, address, mobilenumber, workingtime, duration, hiringdate, additionalservices) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                            ...
                            pst.setString(9, additionalservices);
