...
<body>
    ...
    <div class="form-container">
        ...
        <form method="POST">
            <h3>Selected service is Elder Care</h3>
            <%
                int i = 0;
            ...
            <label for="age">Age of the care recipient:</label>
            <input type="text" name="age" id="age" placeholder="Age of the care recipient" required>
            
            <label for="healthcondition">Any Health Condition:</label>
            <input type="text" name="healthcondition" id="healthcondition" placeholder="Any Health Condition" required>
            
            <label for="emecontact">Emergency Contact Information:</label>
            <input type="text" name="emecontact" id="emecontact" placeholder="Emergency Contact Information" pattern="\d{10}" minlength="10" maxlength="10" required>          
            ...
            <%
                if ("POST".equalsIgnoreCase(request.getMethod())) {
                    ...
                    String emecontact = request.getParameter("emecontact");
                
                    if (clientid != null && name != null && email != null && address != null && 
                        mobilenumber != null && workingtime != null && duration != null && 
                        hiringdate != null && age != null && healthcondition != null && emecontact != null) {

                        try {
                            String query = "INSERT INTO info.client_enquiry3(clientid, name, email, address, mobilenumber, workingtime, duration, hiringdate, age, healthcondition, emecontact) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                            ...
                            pst.setString(9, age);
                            pst.setString(10, healthcondition);
                            pst.setInt(11, Integer.parseInt(emecontact));
