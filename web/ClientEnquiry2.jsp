...
<body>
    ...
    <div class="form-container">
        ...
        <form method="POST">
            <h3>Selected service is Cleaning</h3>
            <%
                int i = 0;
            ...
            <input type="number" name="norooms" id="norooms" placeholder="Number of rooms to be cleaned" min="1" max="20" required>
            ...
            <%
                if ("POST".equalsIgnoreCase(request.getMethod())) {
                    ...
                    if (clientid != null && name != null && email != null && address != null && 
                        ...
                        hiringdate != null && norooms != null) {

                        try {
                            String query = "INSERT INTO client_enquiry2 (clientid, name, email, address, mobilenumber, workingtime, duration, hiringdate, norooms) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                            ...
                            pst.setInt(9, Integer.parseInt(norooms));
